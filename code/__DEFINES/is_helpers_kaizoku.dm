...
// Church
	...
	#define is_monk_job(job_type) (istype(job_type, /datum/job/kaizoku/votary))
...
// Serfs
	// #define is_gaffer_job(job_type) (istype(job_type, /datum/job/gaffer)) //Stonekeep Edit: We don't have these.
// Peasantry
	#define is_jester_job(job_type) (istype(job_type, /datum/job/kaizoku/performer))
	#define is_adventurer_job(job_type) (istype(job_type, /datum/job/advclass/adventurer))
	//#define is_mercenary_job(job_type) (istype(job_type, /datum/job/advclass/mercenary) || istype(job_type, /datum/job/stonekeep/mercenary)) // Our mercenaries became adventurers and Cutthroats.
	#define is_pilgrim_job(job_type) (istype(job_type, /datum/job/advclass/pilgrim))
	#define is_vagrant_job(job_type) (istype(job_type, /datum/job/kaizoku/lowlife))
//  Apprentices
