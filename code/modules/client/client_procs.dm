...
/client/New(TopicData)
	...
	// patreon = new(src) // Stonekeep Edit: Patreon Bullshit. Kaizoku will NEVER follow the same steps.
	// twitch = new(src) // Stonekeep Edit: Patreon Bullshit. Kaizoku will NEVER follow the same steps.
...
/* Stonekeep Edit: Patreon removal.
