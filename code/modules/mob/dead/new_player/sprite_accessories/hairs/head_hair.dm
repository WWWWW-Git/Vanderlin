...
/datum/sprite_accessory/hair/head/phoenix
	...
	icon_state = "phoenix"
	gender = NEUTER
	specuse = list(SPEC_ID_HUMEN, SPEC_ID_DWARF, SPEC_ID_ELF, SPEC_ID_AASIMAR, SPEC_ID_TIEFLING, SPEC_ID_VESSEL, SPEC_ID_SUNSCORNED, SPEC_ID_OGRUN, SPEC_ID_UNDINE, SPEC_ID_CHANGELING, SPEC_ID_SKYLANCER, SPEC_ID_GROVELING, SPEC_ID_DENMORIAN) //Stonekeep Edit
