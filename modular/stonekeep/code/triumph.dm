/datum/triumph_buy/adoption // disable
	visible_on_active_menu = FALSE
	triumph_buy_id = null
	category = null

/datum/triumph_buy/fart // disable
	visible_on_active_menu = FALSE
	triumph_buy_id = null
	category = null

/datum/triumph_buy/race_all_jobs // disable
	visible_on_active_menu = FALSE
	triumph_buy_id = null
	category = null
...
/datum/advclass/pick_special
	name = "Subversive Agent"
	tutorial = "This will open up another menu when you spawn allowing you to pick from a list of special classes."
