...
/obj/item/clothing/gloves/fingerless/yugake
	...
	desc = "The 'Yugake', a traditional archery gloves used by foglanders to protect the fingers from the impact of the bow's string."
	icon_state = "yugake"
	icon = 'modular/kaizoku/icons/clothingicon/gloves.dmi'
	mob_overlay_icon = 'modular/kaizoku/icons/clothing/gloves.dmi'
	sleeved = 'modular/kaizoku/icons/clothing/gloves.dmi'
