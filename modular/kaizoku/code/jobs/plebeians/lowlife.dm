...
/datum/job/kaizoku/lowlife
	...
	outfit = /datum/outfit/kaizoku/lowlife
	can_random = FALSE

	can_have_apprentices = FALSE
	cmode_music = 'sound/music/cmode/towner/CombatBeggar.ogg'

/datum/job/kaizoku/lowlife/New()
	. = ..()
	peopleknowme = list()

/datum/job/kaizoku/lowlife/after_spawn(mob/living/spawned, client/player_client)
	..()
	if(ishuman(spawned))
...
/datum/outfit/kaizoku/lowlife/pre_equip(mob/living/carbon/human/H)
	..()
	if(prob(20))
